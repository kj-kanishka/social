...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _MemoryRouter = __webpack_require__(159);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _universalCookie = __webpack_require__(235);
	...
	all.isLoggedIn = function (cb) {
		...
		if (token) {
			...
			console.log("axios.defaults.headers.common", _axios2.default.defaults.headers.common);
			_axios2.default.get('/api/ping').then(function (response) {
	...
	all.logout = function () {
		...
		_axios2.default.delete('/api/user/session').then(function (response) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Cookies = __webpack_require__(236);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _cookie = __webpack_require__(237);
	...
	exports.default = function () {
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/friends', component: _home2.default }),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reactMtSvgLines = __webpack_require__(241);
	...
	var Home = function (_React$Component) {
	  ...
	  _createClass(Home, [{
	    ...
	    value: function componentDidUpdate() {
	      ...
	      } else if (this.props.location.pathname != "/friends" && this.state.onlyfriends == true) {
	    ...
	    key: 'canclereq',
	    value: function canclereq(data) {
	      var _this3 = this;

	      _axios2.default.put('/api/addfriends', {
	        userId: data._id
	    ...
	    key: 'unfriend',
	    value: function unfriend(data) {
	      var _this4 = this;

	      _axios2.default.put('/api/friends', {
	        userId: data._id
	      }).then(function (response) {
	    ...
	    key: 'acceptreq',
	    value: function acceptreq(data) {
	      var _this5 = this;

	      _axios2.default.post('/api/friends', {
	        userId: data._id
	    ...
	    value: function addfriend(data) {
	      ...
	      _axios2.default.post('/api/addfriends', {
	        userId: data._id
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'search' },
	          _react2.default.createElement('input', { type: 'text', className: 'searchTerm', onChange: this.handlesearch.bind(this), placeholder: 'Enter a Name or email Id' })
	        ),
	        _react2.default.createElement(
	          'div',
	          null,
	          this.state.friends.map(function (data) {
	            return _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'button',
	                { className: 'unfriend', type: 'submit', onClick: that.unfriend.bind(that, data) },
	                'Unfriend '
	              )
	            );
	          })
	        ...
	        function () {
	          if (!that.state.onlyfriends) return _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement(
	              'div',
	              ...
	              that.state.requested.map(function (data) {
	                return _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    'button',
	                    { className: 'canclereq', type: 'submit', onClick: that.canclereq.bind(that, data) },
	                    'Cancle request '
	                  )
	                );
	              })
	            ...
	            _react2.default.createElement(
	              ...
	              that.state.recieved.map(function (data) {
	                return _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    'button',
	                    { className: 'acceptreq', type: 'submit', onClick: that.acceptreq.bind(that, data) },
	                    'Accept '
	                  ),
	                  _react2.default.createElement(
	                    'button',
	            ...
	            _react2.default.createElement(
	              ...
	              that.state.unknown.map(function (data) {
	                ...
	                return _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    'button',
	                    { className: 'addfriend', type: 'submit', onClick: that.addfriend.bind(that, data) },
	                    'Add Friend '
	                  )
	                );
	              })
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _tween = __webpack_require__(243);
	...
	var Login = function (_React$Component) {
	  ...
	  _createClass(Login, [{
	    ...
	    value: function submitLogin(e) {
	      ...
	      _axios2.default.post('/api/user/session', {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'li',
	            null,
	            _react2.default.createElement('input', { type: 'submit', onClick: this.submitLogin, value: 'Login' }),
	            _react2.default.createElement(
	              'font',
	              null,
	              'New User ??  ',
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'li',
	            null,
	            _react2.default.createElement('input', { type: 'submit', onClick: this.submitSignup, value: 'Sign Up' }),
	            _react2.default.createElement(
	              'font',
	              null,
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement('input', { type: 'text', name: 'field1', onChange: function onChange(e) {
	                ...
	                }, value: that.state.name, className: 'field-style field-full align-none', placeholder: 'Email' })
	            ),
	            _react2.default.createElement(
	              'li',
	              null,
	              ...
	              _react2.default.createElement('input', { type: 'text', name: 'field2', onChange: function onChange(e) {
	                  return _this2.setState({ email: e.target.value });
	                }, value: that.state.email, className: 'field-style field-full align-none', placeholder: 'Email' })
	            ),
	            _react2.default.createElement(
	              'li',
	              null,
	              ...
	              _react2.default.createElement('input', { type: 'number', name: 'field3', onChange: function onChange(e) {
	                  return _this2.setState({ phone: e.target.value });
	                }, value: that.state.phone, className: 'field-style field-full align-none', placeholder: 'Email' })
	            ),
	            _react2.default.createElement(
	              'li',
	              null,
	              _react2.default.createElement('input', { type: 'submit', onClick: this.submitData, value: 'Save' })
	            )
	          )
	        )
	      );
